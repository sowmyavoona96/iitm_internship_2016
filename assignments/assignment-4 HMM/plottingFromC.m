...
% end
    ...
    plotconfusion(actualDigit,transpose(digitRec),'trainList6(50Symbols)');
    %actualDigit,targetRec(:,:,2),'trainList2',actualDigit,targetRec(:,:,3),'trainList3',actualDigit,targetRec(:,:,4),'trainList4',actualDigit,targetRec(:,:,5),'trainList5',actualDigit,targetRec(:,:,6),'trainList6');
